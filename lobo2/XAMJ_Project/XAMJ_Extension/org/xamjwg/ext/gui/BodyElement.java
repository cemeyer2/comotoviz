...
import org.xamjwg.ext.markup.*;

/**
 * @author J. H. S.
 */
public class BodyElement extends BaseWidgetElement implements XBodyElement {
	...
	public void appendChild(XNode node) {
		if(node instanceof BaseMarkupElement) {
			((BaseMarkupElement) node).setContainerWidget(((WBody) this.widget).component);
		}
