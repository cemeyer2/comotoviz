 ...
 * @author J. H. S.
 */
public class ConsoleElement extends BaseWidgetElement implements XConsoleElement {
	/**
	 * @param name
	 */
	public ConsoleElement(String name) {
		super(name);
	}
	 ...
	 * @param name
	 * @param widget
	 * @param isWidgetElement
	 */
	public ConsoleElement(String name, Widget widget, boolean isWidgetElement) {
