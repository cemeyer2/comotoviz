 ...
 * @author J. H. S.
 */
public interface LocalTreeNodeElement extends XTreeNodeElement {
	...
	public LocalTreeNodeElement getChild(int index);
	public int getChildCount();
	public java.util.Iterator getChildNodes(XamjNodeFilter filter);
}
