 ...
 * @author J. H. S.
 */
public class DoOpenElement extends BaseGoToUrlActionElement {

	/**
	 * @param name
	 */
	public DoOpenElement(String name) {
		super(name);
	}
	...
	protected void goTo(URL url, String method, ParameterInfo pinfo) {
		this.document.getClientletContext().getClientletFrame().open(url, method, pinfo);
	}
}
