...
import org.xamjwg.dom.XStyleSheetElement;

/**
 * @author J. H. S.
 */
public class StyleSheetElement extends BaseElement implements
        XStyleSheetElement {
    /**
     * @param name
     */
    public StyleSheetElement(String name) {
        super(name);
    }
	...
	/* (non-Javadoc)
	 * @see org.xamjwg.dom.XMetaElement#getInnerText()
	 */
	public String getInnerText() {
		return "Style-Sheet-Element-TODO";
	}
