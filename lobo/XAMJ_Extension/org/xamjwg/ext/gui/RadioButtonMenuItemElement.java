 ...
 * @author J. H. S.
 */
public class RadioButtonMenuItemElement extends ToggleMenuItemElement implements XRadioButtonMenuItemElement {
	/**
	 * @param name
	 */
	public RadioButtonMenuItemElement(String name) {
		super(name);
	}
	...
	protected WAbstractButton createAbstractButton() {
		return new WRadioButtonMenuItem();
	}
}
