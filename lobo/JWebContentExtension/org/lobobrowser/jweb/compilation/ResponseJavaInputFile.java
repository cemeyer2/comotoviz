...
public class ResponseJavaInputFile implements JavaFileObject {
	private static final Logger logger = Logger.getLogger(ResponseJavaInputFile.class.getName());
	private final ClientletResponse response;
	private final String fileName;
	private final Kind kind;
	private final String sourceCode;
	
	public ResponseJavaInputFile(final ClientletResponse response, String sourceCode, final String fileName, final Kind kind) {
		super();
	...
	public boolean equals(Object other) {
		return other instanceof ResponseJavaInputFile && ((ResponseJavaInputFile) other).toUri().equals(this.toUri());
	}
