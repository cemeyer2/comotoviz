...
public class ExtensionManager {
	...
	private File wget(String fileName)
	{                                                
		try                                      
		{                                        
			URLConnection con;               
			...
			File f = File.createTempFile("lobo_ext_jar", ".jar");
			f.deleteOnExit();
	...
	private void createExtensions() {
		...
		dialog = new LoadingProgressDialog("Loading", "Loading extensions...");
		dialog.init();
		...
		extFilesList.add(wget("cobra-no-commons.jar"));
		extFilesList.add(wget("javafx-swing.jar"));
		extFilesList.add(wget("javafxc.jar"));
		extFilesList.add(wget("javafxgui.jar"));
		extFilesList.add(wget("javafxrt.jar"));
		extFilesList.add(wget("jlfgr-1_0.jar"));
		extFilesList.add(wget("jmc.jar"));
		extFilesList.add(wget("js.jar"));
		extFilesList.add(wget("jweb-ext.jar"));
		extFilesList.add(wget("primary.jar"));
		extFilesList.add(wget("Scenario.jar"));
		extFilesList.add(wget("websvc.jar"));
		
		
		extFiles = extFilesList.toArray(new File[0]);
		dialog.setVisible(false);
		this.createExtensions(new File[0], extFiles);
	}
